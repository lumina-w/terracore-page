...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      'Finanzas (P&L mensual + patrimonio estimado, solo lectura)',
  ...
  },
  {
    ...
    features: [
      ...
      'Todo lo de Semilla +',
      'Hasta 5 sedes con permisos por sede',
      'Hasta 10 usuarios con roles configurables',
      'Herramientas (mantenimiento)',
      'Finanzas intermedia: costo y margen por lote, ranking rentabilidad, alertas costo > ingreso, vista por sede y consolidada',
